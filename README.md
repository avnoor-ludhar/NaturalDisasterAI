...
Use below command and make sure python version is 3.11.4
...
- Fix Jose file when you install dependencies, remove the print word
- fix bcrypt file take out the .__about__ in it